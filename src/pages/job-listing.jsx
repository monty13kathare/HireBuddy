...
const JobListing = () => {
    ...
    }, [company_id, location, searchQuery, isLoaded])
    ...
    return (
        <div>
            <h1 className='font-extrabold text-6xl sm:text-7xl text-center pb-8'><span className='text-indigo-700'>Latest </span>Jobs </h1>

            {/* Add filters here */}
            <form onSubmit={handleSearch} className='h-14 w-full gap-4 flex items-center mb-3'>
                <Input
                    type="text"
            ...
            <div className='flex flex-col sm:flex-row gap-2'>
                ...
                <Button onClick={clearFilters} variant="indigo" className="sm:w-1/2">Clear Filters</Button>
            </div>
