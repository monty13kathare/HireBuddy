...
const schema = z.object({
    ...
    resume: z.any().refine(
        (file) => file[0] && (file[0].type === "application/pdf" || file[0].type === "application/msword"),
    ...
    return (
        <Drawer open={applied ? false : undefined}>
            <DrawerTrigger asChild>
                <Button
                    variant={job?.isOpen && !applied ? "indigo" : "destructive"}
            ...
            <DrawerContent>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4 p-4 pb-0'>
                    <Input
                        type="number"
                        placeholder="Years of Expereience"
                        className="flex-1"
                        {
                        ...register("experience", {
                            valueAsNumber: true
                    ...
                    <Button type="submit" variant="indigo" size="lg">Apply</Button>
                </form>
                <DrawerFooter>
